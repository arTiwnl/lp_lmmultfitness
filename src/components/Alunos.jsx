    ...
    <div class="md:columns-2 lg:columns-3 gap-8 space-y-8">
        ...
        <div
            ...
            <div class="flex gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 ">Aluna</p>
        ...
        <div
            ...
            <div class="flex gap-4">
                ...
                <div>
                    <h6 class="text-lg font-medium text-gray-700">Júlia Reis</h6>
                    <p class="text-sm text-gray-500 ">Aluna</p>
                </div>
            </div>
            <p class="mt-8"> Studio super limpo, organizado. Funcionários e alunos receptivos, aulas super animadas.
            Super recomendo!
            </p>
        </div>
        ...
        <div
            ...
            <div class="flex gap-4">
                ...
                <div>
                    <h6 class="text-lg font-medium text-gray-700 ">Marcos Bicocchi</h6>
                    <p class="text-sm text-gray-500 ">Aluno</p>
                </div>
            </div>
            <p class="mt-8">Quem procura um ótimo local para fazer, suas atividades esportivas aí é o local ideal, sem falar dos propetarios, que são da melhor qualidade.
            </p>
        </div>
