...
<>
<section>
  <div className="mx-auto max-w-screen-xl px-4 py-28 sm:px-6 sm:py-22 lg:px-8 lg:py-18">
    <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
      <div className="mx-auto max-w-lg text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
        <h2 className="text-3xl font-bold sm:text-4xl">Modalidades</h2>
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 py-6">
